...
class CmsController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('admin')->attempt(['email' => $request['email'], 'password' => $request['password']])) {
            ...
            $cookie = Cookie::make('zenbolt_cms_login_date', $cookieValue, 120); // 120 minutes expiration time
    ...
    {
        return response()->view('cms::pages/profile/show')->withCookie(cookie('zenbolt_cms_login_date', now(), 120));
    }
