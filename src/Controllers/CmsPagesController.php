...
class CmsPagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return url(config('zenbolt.cms_route_prefix') . '/' . $cms_page->route);
    }
    ...
    public function storeCustom(Request $request)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/cms-pages')->with('success', 'Page added successfully');
    }
    ...
    public function updateCustom(Request $request, $id)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/cms-pages')->with('success', 'Page edited successfully');
    }
    ...
    {
        $array = explode(',', $id);
        if (!count($array)) return redirect(config('zenbolt.cms_route_prefix') . '/cms-pages')->with('error', 'No record selected');
        foreach ($array as $id) $this->deletePage($id);
        return redirect(config('zenbolt.cms_route_prefix') . '/cms-pages')->with('success', 'Record deleted successfully');
    }
    ...
    public function changeOrder(Request $request)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/cms-pages')->with('success', 'Records ordered successfully');
    }
