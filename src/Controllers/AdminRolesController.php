...
class AdminRolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return url(config('zenbolt.cms_route_prefix') . '/admin-roles');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/admin-roles')->with('success', 'Record deleted successfully');
    }
