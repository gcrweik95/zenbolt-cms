...
class CmsPageController extends Controller
{
    ...
    public function index($route)
    {
        ...
        if ($page['single_record']) {
            ...
            return redirect(config('zenbolt.cms_route_prefix') . '/' . $route . '/' . $row['id']);
        }
    ...
    public function store(Request $request, $route)
    {
        ...
        return url(config('zenbolt.cms_route_prefix') . '/' . $route);
    }
    ...
    public function update(Request $request, $id, $route)
    {
        ...
        return url(config('zenbolt.cms_route_prefix') . '/' . $route . $this->appends_to_query);
    }
    ...
    public function destroy($id, $route)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/' . $route . $appends_to_query)->with('success', 'Record deleted successfully');
    }
    ...
    public function changeOrder(Request $request, $route)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/' . $route)->with('success', 'Records ordered successfully');
    }

    public function compressImage($path)
    {
        if (config('zenbolt.tinify.key')) {
            try {
                \Tinify\setKey(config('zenbolt.tinify.key'));
    ...
    public function uploadFile($file, $route)
    {
        ...
        if (config('zenbolt.use_original_name')) {
