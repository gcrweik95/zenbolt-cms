...
class AdminsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return url(config('zenbolt.cms_route_prefix') . '/admins');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(config('zenbolt.cms_route_prefix') . '/admins')->with('success', 'Record deleted successfully');
    }
}
