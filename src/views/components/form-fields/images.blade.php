...
<div class="form-group multiple-images-wrapper" data-input-name="{{ $input_name }}[]" data-ajax-url="{{ url(config('zenbolt.cms_route_prefix') . '/' . $page['route'] . '/edit/images') }}" data-method="{{ isset($row) ? 'PUT' : 'POST' }}">
