				...
				<div class="col-md-6 pr-md-5 text-center">
					<div class="d-table w-100 h-100">
						<div class="d-table-cell align-middle">
							<img class="w-100 mb-4 mb-md-3" src="{{ url(config('zenbolt.logo')) }}">
							@if (config('zenbolt.login_text'))
							<p class="font-weight-bold mb-4 mb-md-5 mb-md-0 d-none d-md-block">{{ config('zenbolt.login_text') }}</p>
							@endif
						</div>
					</div>
				</div>
