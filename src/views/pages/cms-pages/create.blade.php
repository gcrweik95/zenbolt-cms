...
<form method="post" action="{{ isset($cms_page)? url(config('zenbolt.cms_route_prefix') . '/cms-pages/' . $cms_page['id']): url(config('zenbolt.cms_route_prefix') . '/cms-pages') }}" ajax>
        ...
        <div class="form-group m-0">
            <label class="m-0">
                <ul>
                    ...
                    <li>The icon is the class of a font-awesome icon, you will see the icon in the menu <a href="{{ url(config('zenbolt.cms_route_prefix') . '/cms-pages/icons') }}" target="_blank"><u>click here to see all the icons</u></a>.</li>
    ...
    <div class="card p-4 mx-2 mx-sm-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    <label class="d-block mb-1">Hidden</label>
                    @include('cms::/components/form-fields/checkbox', [
                    'label' => 'Yes',
                    'name' => 'hidden',
                    'inline_label' => true,
                    'checked' => isset($cms_page['hidden']) ? $cms_page['hidden'] : '',
                    'locale' => null,
                    ])
                </div>
            </div>
            ...
            <table class="fields table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Hide Show <span class="text-danger">*</span></th>
            ...
            <table class="fields table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Form Field <span class="text-danger">*</span></th>
                        <th class="text-center">Description</th>
                        <th class="text-center">Hide Index</th>
                        <th class="text-center">Hide Create</th>
                        <th class="text-center">Hide Edit</th>
