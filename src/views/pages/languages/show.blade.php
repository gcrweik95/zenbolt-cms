...
<ul class="breadcrumbs list-inline font-weight-bold text-uppercase m-0">
    <li><a href="{{ url(config('zenbolt.cms_route_prefix') . '/languages') }}">Languages</a></li>
    <li><a href="{{ url(config('zenbolt.cms_route_prefix') . '/languages/' . $row['id']) }}">{{ $row['id'] }}</a></li>
    <li>Show</li>
</ul>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-lg-6 text-right">
            <div class="actions p-0">
                ...
                <a href="{{ url(config('zenbolt.cms_route_prefix') . '/languages/' . $row['id'] . '/edit') }}" class="btn btn-sm btn-primary">Edit</a>
                @endif
