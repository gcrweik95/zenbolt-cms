...
<form method="post" enctype="multipart/form-data" action="{{ isset($row) ? url(config('zenbolt.cms_route_prefix') . '/languages/' . $row['id']) : url(config('zenbolt.cms_route_prefix') . '/languages') }}" ajax>
