...
<div class="row no-gutters">
    <div class="col-lg-6 mb-lg-4">
        <div class="pr-lg-3">
            <form method="post" enctype="multipart/form-data" action="{{ isset($row) ? url(config('zenbolt.cms_route_prefix') . '/' . $page['route'] . '/' . $row['id'] . $appends_to_query) : url(config('zenbolt.cms_route_prefix') . '/' . $page['route'] . '') }}" ajax>
